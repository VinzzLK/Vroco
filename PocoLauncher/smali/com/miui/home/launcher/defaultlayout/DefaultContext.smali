...
# instance fields
.field private final mAllApps:Ljava/util/Collection;
...
.field private final mContentValuesList:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
# direct methods
.method public constructor <init>(Landroid/database/sqlite/SQLiteDatabase;ILandroid/content/Context;Landroid/appwidget/AppWidgetHost;Ljava/util/Collection;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    const-string v0, "getInstance().resources.getXml(layoutID)"
    ...
    .line 36
    iput-object p5, p0, Lcom/miui/home/launcher/defaultlayout/DefaultContext;->mAllApps:Ljava/util/Collection;
    ...
    iput-object p1, p0, Lcom/miui/home/launcher/defaultlayout/DefaultContext;->mContentValuesList:Ljava/util/ArrayList;
    ...
    const-string p3, "mContext.packageManager"
    ...
    const-string p3, "asAttributeSet(parser)"
    ...
    .line 45
    invoke-static {p2, p0}, Lcom/miui/launcher/utils/LauncherFastXmlSerializer;->beginDocument(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)V
...
.method public final getCurrentTypedArray()Landroid/content/res/TypedArray;
    ...
    invoke-virtual {v0, p0, v1}, Landroid/app/Application;->obtainStyledAttributes(Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;

    move-result-object p0

    const-string v0, "getInstance().obtainStyl\u2026rs, R.styleable.Favorite)"
...
.method public final getMAllApps()Ljava/util/Collection;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 36
    iget-object p0, p0, Lcom/miui/home/launcher/defaultlayout/DefaultContext;->mAllApps:Ljava/util/Collection;
...
.method public final getMContentValuesList()Ljava/util/ArrayList;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 37
    iget-object p0, p0, Lcom/miui/home/launcher/defaultlayout/DefaultContext;->mContentValuesList:Ljava/util/ArrayList;
