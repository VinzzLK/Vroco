...
.method private static final createVertexBuffer(Lcom/google/android/filament/Engine;Lcom/miui/maml/elements/filament/Header;Ljava/nio/ByteBuffer;)Lcom/google/android/filament/VertexBuffer;
    ...
    .line 277
    invoke-static {p1}, Lcom/miui/maml/elements/filament/MeshLoaderKt;->uvNormalized(Lcom/miui/maml/elements/filament/Header;)Z
    ...
    .line 285
    invoke-virtual {p1}, Lcom/miui/maml/elements/filament/Header;->getTotalVertices()J
    ...
    invoke-virtual {v1, v3}, Lcom/google/android/filament/VertexBuffer$Builder;->normalized(Lcom/google/android/filament/VertexBuffer$VertexAttribute;)Lcom/google/android/filament/VertexBuffer$Builder;
    ...
    invoke-virtual {v1, v5}, Lcom/google/android/filament/VertexBuffer$Builder;->normalized(Lcom/google/android/filament/VertexBuffer$VertexAttribute;)Lcom/google/android/filament/VertexBuffer$Builder;

    move-result-object v6

    .line 292
    sget-object v7, Lcom/google/android/filament/VertexBuffer$VertexAttribute;->POSITION:Lcom/google/android/filament/VertexBuffer$VertexAttribute;

    const/4 v8, 0x0

    sget-object v9, Lcom/google/android/filament/VertexBuffer$AttributeType;->HALF4:Lcom/google/android/filament/VertexBuffer$AttributeType;

    invoke-virtual {p1}, Lcom/miui/maml/elements/filament/Header;->getPosOffset()J

    move-result-wide v1

    long-to-int v10, v1

    invoke-virtual {p1}, Lcom/miui/maml/elements/filament/Header;->getPositionStride()J

    move-result-wide v1

    long-to-int v11, v1

    invoke-virtual/range {v6 .. v11}, Lcom/google/android/filament/VertexBuffer$Builder;->attribute(Lcom/google/android/filament/VertexBuffer$VertexAttribute;ILcom/google/android/filament/VertexBuffer$AttributeType;II)Lcom/google/android/filament/VertexBuffer$Builder;
    ...
    .line 293
    sget-object v7, Lcom/google/android/filament/VertexBuffer$AttributeType;->SHORT4:Lcom/google/android/filament/VertexBuffer$AttributeType;

    invoke-virtual {p1}, Lcom/miui/maml/elements/filament/Header;->getTangentOffset()J

    move-result-wide v1

    long-to-int v8, v1

    invoke-virtual {p1}, Lcom/miui/maml/elements/filament/Header;->getTangentStride()J
    ...
    invoke-virtual {p1}, Lcom/miui/maml/elements/filament/Header;->getColorOffset()J

    move-result-wide v6

    long-to-int v6, v6

    invoke-virtual {p1}, Lcom/miui/maml/elements/filament/Header;->getColorStride()J
    ...
    invoke-virtual {p1}, Lcom/miui/maml/elements/filament/Header;->getUv0Offset()J

    move-result-wide v4

    long-to-int v5, v4

    invoke-virtual {p1}, Lcom/miui/maml/elements/filament/Header;->getUv0Stride()J
    ...
    invoke-virtual {v1, v7, v2}, Lcom/google/android/filament/VertexBuffer$Builder;->normalized(Lcom/google/android/filament/VertexBuffer$VertexAttribute;Z)Lcom/google/android/filament/VertexBuffer$Builder;
    ...
    .line 303
    invoke-virtual {p1}, Lcom/miui/maml/elements/filament/Header;->getUv1Offset()J
    ...
    invoke-virtual {p1}, Lcom/miui/maml/elements/filament/Header;->getUv1Stride()J
    ...
    .line 305
    sget-object v8, Lcom/google/android/filament/VertexBuffer$VertexAttribute;->UV1:Lcom/google/android/filament/VertexBuffer$VertexAttribute;
    ...
    invoke-virtual {v0, v8, p1}, Lcom/google/android/filament/VertexBuffer$Builder;->normalized(Lcom/google/android/filament/VertexBuffer$VertexAttribute;Z)Lcom/google/android/filament/VertexBuffer$Builder;

    .line 309
    :cond_1
    invoke-virtual {v7, p0}, Lcom/google/android/filament/VertexBuffer$Builder;->build(Lcom/google/android/filament/Engine;)Lcom/google/android/filament/VertexBuffer;

    move-result-object p1

    const-string v0, "vertexBufferBuilder.build(engine)"

    invoke-static {p1, v0}, Lkotlin/jvm/internal/Intrinsics;->checkNotNullExpressionValue(Ljava/lang/Object;Ljava/lang/String;)V

    const/4 v0, 0x0

    invoke-virtual {p1, p0, v0, p2}, Lcom/google/android/filament/VertexBuffer;->setBufferAt(Lcom/google/android/filament/Engine;ILjava/nio/Buffer;)V
...
.method public static final loadDefaultMesh(Lcom/google/android/filament/MaterialInstance;Lcom/google/android/filament/Engine;)Lcom/miui/maml/elements/filament/Mesh;
    ...
    sget-object v0, Lcom/google/android/filament/VertexBuffer$AttributeType;->FLOAT2:Lcom/google/android/filament/VertexBuffer$AttributeType;
...
.method public static final loadMesh(Lcom/miui/maml/ResourceManager;Ljava/lang/String;Ljava/util/Map;Lcom/google/android/filament/Engine;)Lcom/miui/maml/elements/filament/Mesh;
    ...
    invoke-static {p0}, Lcom/miui/maml/elements/filament/MeshLoaderKt;->readHeader(Ljava/io/InputStream;)Lcom/miui/maml/elements/filament/Header;
    ...
    invoke-virtual {p1}, Lcom/miui/maml/elements/filament/Header;->getVerticesSizeInBytes()J

    move-result-wide v1

    invoke-static {v0, v1, v2}, Lcom/miui/maml/elements/filament/MeshLoaderKt;->readSizedData(Ljava/nio/channels/ReadableByteChannel;J)Ljava/nio/ByteBuffer;

    move-result-object v1

    .line 54
    invoke-virtual {p1}, Lcom/miui/maml/elements/filament/Header;->getIndicesSizeInBytes()J

    move-result-wide v2

    invoke-static {v0, v2, v3}, Lcom/miui/maml/elements/filament/MeshLoaderKt;->readSizedData(Ljava/nio/channels/ReadableByteChannel;J)Ljava/nio/ByteBuffer;

    move-result-object v0

    .line 56
    invoke-static {p1, p0}, Lcom/miui/maml/elements/filament/MeshLoaderKt;->readParts(Lcom/miui/maml/elements/filament/Header;Ljava/io/InputStream;)Ljava/util/List;

    move-result-object v4

    .line 57
    invoke-static {p0}, Lcom/miui/maml/elements/filament/MeshLoaderKt;->readMaterials(Ljava/io/InputStream;)Ljava/util/List;

    move-result-object v5

    .line 59
    invoke-static {p3, p1, v0}, Lcom/miui/maml/elements/filament/MeshLoaderKt;->createIndexBuffer(Lcom/google/android/filament/Engine;Lcom/miui/maml/elements/filament/Header;Ljava/nio/ByteBuffer;)Lcom/google/android/filament/IndexBuffer;

    move-result-object v7

    .line 60
    invoke-static {p3, p1, v1}, Lcom/miui/maml/elements/filament/MeshLoaderKt;->createVertexBuffer(Lcom/google/android/filament/Engine;Lcom/miui/maml/elements/filament/Header;Ljava/nio/ByteBuffer;)Lcom/google/android/filament/VertexBuffer;
    ...
    .line 62
    invoke-static/range {v0 .. v6}, Lcom/miui/maml/elements/filament/MeshLoaderKt;->createRenderable(Lcom/google/android/filament/Engine;Lcom/miui/maml/elements/filament/Header;Lcom/google/android/filament/IndexBuffer;Lcom/google/android/filament/VertexBuffer;Ljava/util/List;Ljava/util/List;Ljava/util/Map;)I
    ...
    invoke-direct {p3, p2, v7, v8, p1}, Lcom/miui/maml/elements/filament/Mesh;-><init>(ILcom/google/android/filament/IndexBuffer;Lcom/google/android/filament/VertexBuffer;Lcom/google/android/filament/Box;)V
    :try_end_0
