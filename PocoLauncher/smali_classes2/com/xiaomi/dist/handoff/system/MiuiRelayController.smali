...
.method startTransferSessionToLocal(Landroid/content/Context;ILcom/xiaomi/dist/handoff/system/callback/TransferSessionToLocalCallback;)V
    ...
    const-string v3, "startTransferSessionToLocal, handoffTaskId=%s"

    invoke-static {v1, v3, v0}, Lcom/xiaomi/dist/handoff/system/Log;->i(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    const-string v3, "miui relay task not found"

    .line 109
    invoke-interface {p3, v0, v3}, Lcom/xiaomi/dist/handoff/system/callback/TransferSessionToLocalCallback;->onError(ILjava/lang/String;)V
    ...
    invoke-virtual {v0}, Lcom/xiaomi/dist/handoff/parcel/LocalHandoffTask;->getHandoffTaskId()I
    ...
    .line 115
    iget-object p2, p0, Lcom/xiaomi/dist/handoff/system/MiuiRelayController;->mCurrentTasks:[Lcom/xiaomi/dist/handoff/parcel/LocalHandoffTask;

    aget-object p2, p2, v2

    invoke-virtual {p2}, Lcom/xiaomi/dist/handoff/parcel/LocalHandoffTask;->getAppMeta()Lcom/xiaomi/dist/handoff/AppMeta;

    move-result-object p2

    invoke-virtual {p2}, Lcom/xiaomi/dist/handoff/AppMeta;->getAndroidPackageName()Ljava/lang/String;
    ...
    invoke-virtual {p0, p1, p2}, Lcom/xiaomi/mirror/synergy/RelayIconHelper;->performIconClick(Landroid/content/Context;Ljava/lang/String;)V
    ...
    const-string p1, "mRelayIconHelper.performIconClick fail handoffTaskId: "
