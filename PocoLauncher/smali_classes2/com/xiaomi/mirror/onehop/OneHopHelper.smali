...
.method public registerOneHopShareReceiver(Landroid/content/Context;Lcom/xiaomi/mirror/onehop/OneHopHelper$OneHopShareCallback;)V
    ...
    invoke-virtual {v3, p2}, Landroid/content/IntentFilter;->setPriority(I)V

    const-string p2, "com.miui.onehop.action.MIRROR"
    ...
    iget-object v2, p0, Lcom/xiaomi/mirror/onehop/OneHopHelper;->mOneHopShareReceiver:Landroid/content/BroadcastReceiver;

    const/4 v5, 0x0

    const/4 v6, 0x2

    const-string v4, "com.miui.onehop.permission.MIRROR"
    ...
    const-string v0, "com.miui.onehop.permission.MIRROR"

    invoke-virtual {p1, p0, v3, v0, p2}, Landroid/content/Context;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;Ljava/lang/String;Landroid/os/Handler;)Landroid/content/Intent;
