...
.field private static final TAG:Ljava/lang/String; = "MirrorDesktopHelper"
...
.field private mMirrorDesktopCallback:Lcom/xiaomi/mirror/synergy/MirrorDesktopCallback;
...
.method private isDesktopCallbackValid()Z
    ...
    iget-object p0, p0, Lcom/xiaomi/mirror/synergy/MirrorDesktopHelper;->mMirrorDesktopCallback:Lcom/xiaomi/mirror/synergy/MirrorDesktopCallback;
    ...
    const-string v1, "isDesktopCallbackValid result = "
    ...
    const-string v1, "MirrorDesktopHelper"
...
.method private mirrorDesktopConfigChanged()V
    ...
    const-string v0, "MirrorDesktopHelper"

    const-string v1, "mirrorDesktopConfigChanged()  "

    invoke-static {v0, v1}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    iget-object v1, p0, Lcom/xiaomi/mirror/synergy/MirrorDesktopHelper;->mMirrorDesktopCallback:Lcom/xiaomi/mirror/synergy/MirrorDesktopCallback;

    if-nez v1, :cond_0

    const-string p0, "mirrorDesktopConfigChanged()  mMirrorDesktopCallback is null"
...
.method private mirrorDesktopOpenOrClose()V
    ...
    const-string v1, "mirrorDesktopOpenOrClose"
    ...
    :cond_0
    invoke-interface {p0, v3}, Lcom/xiaomi/mirror/synergy/MirrorDesktopCallback;->onMirrorDeskOpenOrClose(Z)V

    goto :goto_0

    :cond_1
    const-string p0, "mirrorDesktopOpenOrClose mMirrorDesktopCallback is null"
...
.method private mirrorDesktopShowOrHide()V
    ...
    const-string v1, "mirrorDesktopShowOrHide()  "
    ...
    const-string p0, "mirrorDesktopShowOrHide()  mMirrorDesktopCallback is null"
...
.method private mirrorDeviceListClear()V
    ...
    const-string v1, "mirrorDeviceListClear"
    ...
    :cond_0
    const-string p0, "mirrorDeviceListClear mMirrorDesktopCallback is null"
...
.method private mirrorDeviceListUpdate()V
    ...
    const-string v1, "mirrorDeviceListUpdate"
    ...
    iget-object v2, p0, Lcom/xiaomi/mirror/synergy/MirrorDesktopHelper;->mContextRef:Ljava/lang/ref/SoftReference;
    ...
    invoke-virtual {v1, v2}, Lcom/xiaomi/mirror/synergy/MiuiSynergySdk;->queryMirrorDesktopDevices(Landroid/content/Context;)Ljava/util/List;
    ...
    const-string v3, "mirrorDeviceListUpdate deviceInfoList: "
    ...
    invoke-interface {p0, v1}, Lcom/xiaomi/mirror/synergy/MirrorDesktopCallback;->onDeviceListUpdate(Ljava/util/List;)V

    goto :goto_1

    :cond_1
    const-string p0, "mirrorDeviceListUpdate mMirrorDesktopCallback is null"
...
.method private mirrorSeatChanged()V
    ...
    const-string v1, "mirrorSeatChanged()  "
    ...
    const-string p0, "mirrorSeatChanged()  mMirrorDesktopCallback is null"
    ...
    const-string v2, "pref_key_mirror_seat"

    invoke-static {v0, v2, v1}, Lcom/xiaomi/mirror/SystemSettingsUtils;->getInt(Landroid/content/Context;Ljava/lang/String;I)I
...
.method public registerMirrorDesktopCallback(Landroid/content/Context;Lcom/xiaomi/mirror/synergy/MirrorDesktopCallback;Landroid/os/Handler;)V
    ...
    const-string v1, "registerMirrorDesktopCallback() "

    invoke-static {v0, v1}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    iget-object v0, p0, Lcom/xiaomi/mirror/synergy/MirrorDesktopHelper;->mHandler:Landroid/os/Handler;

    if-eqz v0, :cond_0

    iget-object v1, p0, Lcom/xiaomi/mirror/synergy/MirrorDesktopHelper;->mRunnable:Ljava/lang/Runnable;

    invoke-virtual {v0, v1}, Landroid/os/Handler;->removeCallbacks(Ljava/lang/Runnable;)V

    :cond_0
    iput-object p3, p0, Lcom/xiaomi/mirror/synergy/MirrorDesktopHelper;->mHandler:Landroid/os/Handler;
    ...
    iput-object p1, p0, Lcom/xiaomi/mirror/synergy/MirrorDesktopHelper;->mMirrorDesktopCallback:Lcom/xiaomi/mirror/synergy/MirrorDesktopCallback;
    ...
    iput-object p2, p0, Lcom/xiaomi/mirror/synergy/MirrorDesktopHelper;->mMirrorDesktopCallback:Lcom/xiaomi/mirror/synergy/MirrorDesktopCallback;
...
.method public unRegisterMirrorDesktopCallback(Landroid/content/Context;)V
    ...
    iput-object v1, p0, Lcom/xiaomi/mirror/synergy/MirrorDesktopHelper;->mMirrorDesktopCallback:Lcom/xiaomi/mirror/synergy/MirrorDesktopCallback;
    ...
    iget-object v3, p0, Lcom/xiaomi/mirror/synergy/MirrorDesktopHelper;->mDeviceUpdateObserver:Landroid/database/ContentObserver;

    invoke-virtual {v2, v3}, Landroid/content/ContentResolver;->unregisterContentObserver(Landroid/database/ContentObserver;)V

    iput-object v1, p0, Lcom/xiaomi/mirror/synergy/MirrorDesktopHelper;->mDeviceUpdateObserver:Landroid/database/ContentObserver;
    ...
    iget-object v3, p0, Lcom/xiaomi/mirror/synergy/MirrorDesktopHelper;->mDesktopVisibilityObserver:Landroid/database/ContentObserver;

    invoke-virtual {v2, v3}, Landroid/content/ContentResolver;->unregisterContentObserver(Landroid/database/ContentObserver;)V

    iput-object v1, p0, Lcom/xiaomi/mirror/synergy/MirrorDesktopHelper;->mDesktopVisibilityObserver:Landroid/database/ContentObserver;
    ...
    iget-object v3, p0, Lcom/xiaomi/mirror/synergy/MirrorDesktopHelper;->mConfigurationObserver:Landroid/database/ContentObserver;

    invoke-virtual {v2, v3}, Landroid/content/ContentResolver;->unregisterContentObserver(Landroid/database/ContentObserver;)V

    iput-object v1, p0, Lcom/xiaomi/mirror/synergy/MirrorDesktopHelper;->mConfigurationObserver:Landroid/database/ContentObserver;
    ...
    iget-object v3, p0, Lcom/xiaomi/mirror/synergy/MirrorDesktopHelper;->mDesktopOpenObserver:Landroid/database/ContentObserver;

    invoke-virtual {v2, v3}, Landroid/content/ContentResolver;->unregisterContentObserver(Landroid/database/ContentObserver;)V

    iput-object v1, p0, Lcom/xiaomi/mirror/synergy/MirrorDesktopHelper;->mDesktopOpenObserver:Landroid/database/ContentObserver;

    :cond_3
    iget-object v2, p0, Lcom/xiaomi/mirror/synergy/MirrorDesktopHelper;->mSeatObserver:Landroid/database/ContentObserver;
    ...
    iput-object v1, p0, Lcom/xiaomi/mirror/synergy/MirrorDesktopHelper;->mSeatObserver:Landroid/database/ContentObserver;
