...
# static fields
.field private static final TAG:Ljava/lang/String; = "Mirror_:RelayIconHelper"
...
.field private static final deviceSupportPinMap:Ljava/util/Map;
...
.field private mRelayIconList:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Lcom/xiaomi/mirror/synergy/RelayIconHelper$RelayIcon;",
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lcom/xiaomi/mirror/synergy/RelayIconHelper;->deviceSupportPinMap:Ljava/util/Map;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/xiaomi/mirror/synergy/RelayIconHelper;->mRelayIconList:Ljava/util/List;
...
.method public static synthetic access$1000(Lcom/xiaomi/mirror/synergy/RelayIconHelper;Landroid/content/Context;Landroid/net/Uri;)Lcom/xiaomi/mirror/synergy/RelayIconHelper$RelayIcon;
    .locals 0
...
.method public static synthetic access$1100()Landroid/net/Uri;
    .locals 1
...
.method public static synthetic access$1200(Lcom/xiaomi/mirror/synergy/RelayIconHelper;Landroid/content/Context;Landroid/net/Uri;)Lcom/xiaomi/mirror/synergy/RelayIconHelper$RelayResult;
    .locals 0
...
.method public static synthetic access$300(Lcom/xiaomi/mirror/synergy/RelayIconHelper;)Ljava/util/List;
    .locals 0

    iget-object p0, p0, Lcom/xiaomi/mirror/synergy/RelayIconHelper;->mRelayIconList:Ljava/util/List;
...
.method public static synthetic access$600()Ljava/util/Map;
    ...
    sget-object v0, Lcom/xiaomi/mirror/synergy/RelayIconHelper;->deviceSupportPinMap:Ljava/util/Map;

    return-object v0
.end method

.method public static synthetic access$700(Lcom/xiaomi/mirror/synergy/RelayIconHelper;Landroid/content/Context;)V
    .locals 0
...
.method public static synthetic access$800()Landroid/net/Uri;
    .locals 1
...
.method public static synthetic access$900(Lcom/xiaomi/mirror/synergy/RelayIconHelper;Landroid/content/Context;Landroid/net/Uri;)Ljava/util/List;
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/xiaomi/mirror/synergy/RelayIconHelper;->getRelayIconList(Landroid/content/Context;Landroid/net/Uri;)Ljava/util/List;
...
.method private getRelayIcon(Landroid/content/Context;Landroid/net/Uri;)Lcom/xiaomi/mirror/synergy/RelayIconHelper$RelayIcon;
    ...
    invoke-direct/range {v0 .. v8}, Lcom/xiaomi/mirror/synergy/RelayIconHelper$RelayIcon;-><init>(Ljava/lang/String;Landroid/graphics/Bitmap;Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;ZZ)V
    :try_end_0
...
.method private getRelayIconList(Landroid/content/Context;Landroid/net/Uri;)Ljava/util/List;
    .locals 30
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    const-string v3, "getUpdateIconList"

    const/4 v4, 0x0

    invoke-static {v2, v3, v4, v0}, Lcom/xiaomi/mirror/synergy/CallMethod;->doCall(Landroid/content/ContentResolver;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    :cond_0
    const-string v2, "result_get_update_icon_list_first"

    invoke-virtual {v0, v2}, Landroid/os/Bundle;->getBundle(Ljava/lang/String;)Landroid/os/Bundle;

    move-result-object v2

    const-string v3, "result_get_update_icon_list_second"
    ...
    const-string v3, "remote_support_pin"

    const-string v4, "remote_support_handoff"

    const-string v5, "remote_device_id"

    const-string v6, "remote_device_type"
    ...
    new-instance v2, Lcom/xiaomi/mirror/synergy/RelayIconHelper$RelayIcon;

    move-object v12, v2

    invoke-direct/range {v12 .. v20}, Lcom/xiaomi/mirror/synergy/RelayIconHelper$RelayIcon;-><init>(Ljava/lang/String;Landroid/graphics/Bitmap;Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;ZZ)V
    ...
    invoke-virtual {v0, v3, v11}, Landroid/os/Bundle;->getBoolean(Ljava/lang/String;Z)Z
    ...
    invoke-direct/range {v21 .. v29}, Lcom/xiaomi/mirror/synergy/RelayIconHelper$RelayIcon;-><init>(Ljava/lang/String;Landroid/graphics/Bitmap;Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;ZZ)V
...
.method public static isSupportPinByDevice(Ljava/lang/String;)Z
    .locals 2

    sget-object v0, Ljava/lang/Boolean;->TRUE:Ljava/lang/Boolean;

    sget-object v1, Lcom/xiaomi/mirror/synergy/RelayIconHelper;->deviceSupportPinMap:Ljava/util/Map;
...
.method public binderDied()V
    ...
    iget-object v0, p0, Lcom/xiaomi/mirror/synergy/RelayIconHelper;->mRelayIconList:Ljava/util/List;
...
.method public performOpenPhoneApp(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/content/ComponentName;
    .locals 1
    ...
    const-string p2, "remoteDeviceId"
    ...
    const-string p3, "performPinIconClick"
    ...
    const-string p1, "result_activity_component"
