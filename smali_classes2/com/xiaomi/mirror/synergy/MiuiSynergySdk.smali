...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/xiaomi/mirror/synergy/MiuiSynergySdk$PinAppChangeReceiver;,
...
.field private static final ACTION_MIRROR_PIN_APP_CHANGED:Ljava/lang/String; = "miui.intent.action.PIN_APP_CHANGED"
...
.field private static final EXTRA_PIN_APP_CHANGE_ACTION:Ljava/lang/String; = "extra_pin_app_change_action"

.field private static final EXTRA_PIN_APP_CHANGE_APP_PACKAGE_NAME:Ljava/lang/String; = "extra_pin_app_change_app_package_name"

.field private static final EXTRA_PIN_APP_CHANGE_DEVICE_ID:Ljava/lang/String; = "extra_pin_app_change_device_id"

.field public static final PACKAGE_MISHARE:Ljava/lang/String; = "com.miui.mishare.connectivity"

.field private static final PIN_APP_CHANGE_ACTION_PIN_MANAGER_INIT:I = 0x3

.field private static final PIN_APP_CHANGE_ACTION_TYPE_ADD:I = 0x1

.field private static final PIN_APP_CHANGE_ACTION_TYPE_REMOVE:I = 0x2
...
.field private mPinAppChangeCallBack:Lcom/xiaomi/mirror/synergy/PinAppChangeCallBack;

.field private mPinAppReceiver:Landroid/content/BroadcastReceiver;
...
# direct methods
.method public static synthetic $r8$lambda$_Ix0FD0xQCMEbTO0J6-AQPjcBPI(Landroid/content/Context;Lcom/xiaomi/mirror/synergy/GetAllPinAppListCallBack;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/xiaomi/mirror/synergy/MiuiSynergySdk;->lambda$getAllPinApp$0(Landroid/content/Context;Lcom/xiaomi/mirror/synergy/GetAllPinAppListCallBack;)V

    return-void
.end method

.method public static synthetic $r8$lambda$cJOsLKXSfD-xs6WIyj7d6d8XlMg(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/content/Context;)V
    .locals 0

    invoke-static {p0, p1, p2, p3, p4}, Lcom/xiaomi/mirror/synergy/MiuiSynergySdk;->lambda$addPinApp$2(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/content/Context;)V

    return-void
.end method

.method public static synthetic $r8$lambda$e6fNa2XCLOl33sAbIIGkYJjk4Oo(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/content/Context;)V
    .locals 0

    invoke-static {p0, p1, p2, p3, p4}, Lcom/xiaomi/mirror/synergy/MiuiSynergySdk;->lambda$removePinApp$3(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/content/Context;)V

    return-void
.end method

.method public static synthetic $r8$lambda$fJvn04odoB6fCbPPfeQyvyDOsvM(Ljava/util/ArrayList;Landroid/content/Context;Lcom/xiaomi/mirror/synergy/GetAllPinAppListCallBack;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lcom/xiaomi/mirror/synergy/MiuiSynergySdk;->lambda$syncPinApp$1(Ljava/util/ArrayList;Landroid/content/Context;Lcom/xiaomi/mirror/synergy/GetAllPinAppListCallBack;)V
...
.method public static synthetic access$1000(Lcom/xiaomi/mirror/synergy/MiuiSynergySdk;)Lcom/xiaomi/mirror/synergy/PinAppChangeCallBack;
    .locals 0

    iget-object p0, p0, Lcom/xiaomi/mirror/synergy/MiuiSynergySdk;->mPinAppChangeCallBack:Lcom/xiaomi/mirror/synergy/PinAppChangeCallBack;
...
.method private static synthetic lambda$addPinApp$2(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/content/Context;)V
    .locals 2
    ...
    :try_start_1
    const-string p0, "addPinApp result is null "
    ...
    const-string p4, "addPinApp error code = "
...
.method private static synthetic lambda$getAllPinApp$0(Landroid/content/Context;Lcom/xiaomi/mirror/synergy/GetAllPinAppListCallBack;)V
    .locals 4
    ...
    const-string v1, "getAllPinApp"

    const/4 v2, 0x0

    invoke-static {p0, v1, v2, v0}, Lcom/xiaomi/mirror/synergy/CallMethod;->doCall(Landroid/content/ContentResolver;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;

    move-result-object p0
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0

    const-string v0, "MiuiSynergy"

    if-nez p0, :cond_0

    :try_start_1
    const-string p0, "getAllPinApp result is null "
    ...
    const-string v3, "getAllPinApp error code = "
    ...
    invoke-interface {p1, v1, v2}, Lcom/xiaomi/mirror/synergy/GetAllPinAppListCallBack;->onFail(ILjava/lang/String;)V

    goto :goto_1

    :cond_1
    const-string v0, "argPinAppList"
    ...
    invoke-interface {p1, v1, p0}, Lcom/xiaomi/mirror/synergy/GetAllPinAppListCallBack;->onFail(ILjava/lang/String;)V
    ...
    invoke-static {v1}, Lcom/xiaomi/mirror/synergy/PinAppInfo;->pareByString(Ljava/lang/String;)Lcom/xiaomi/mirror/synergy/PinAppInfo;
    ...
    :cond_4
    invoke-interface {p1, v0}, Lcom/xiaomi/mirror/synergy/GetAllPinAppListCallBack;->onSuccess(Ljava/util/List;)V
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_0
    ...
    invoke-interface {p1, v1, v0}, Lcom/xiaomi/mirror/synergy/GetAllPinAppListCallBack;->onFail(ILjava/lang/String;)V
...
.method private static synthetic lambda$removePinApp$3(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/content/Context;)V
    .locals 2
    ...
    :try_start_1
    const-string p0, "removePinApp result is null "
    ...
    const-string p4, "removePinApp error code = "
...
.method private static synthetic lambda$syncPinApp$1(Ljava/util/ArrayList;Landroid/content/Context;Lcom/xiaomi/mirror/synergy/GetAllPinAppListCallBack;)V
    .locals 4
    ...
    check-cast v3, Lcom/xiaomi/mirror/synergy/PinAppInfo;

    invoke-virtual {v3}, Lcom/xiaomi/mirror/synergy/PinAppInfo;->getStr()Ljava/lang/String;
    ...
    const-string p1, "syncPinApp"

    const/4 v2, 0x0

    invoke-static {p0, p1, v2, v1}, Lcom/xiaomi/mirror/synergy/CallMethod;->doCall(Landroid/content/ContentResolver;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    :try_start_1
    const-string p0, "syncPinApp result is null "
    ...
    const-string v0, "syncPinApp error code = "
    ...
    invoke-interface {p2, v1, v2}, Lcom/xiaomi/mirror/synergy/GetAllPinAppListCallBack;->onFail(ILjava/lang/String;)V
    ...
    invoke-static {v0}, Lcom/xiaomi/mirror/synergy/PinAppInfo;->pareByString(Ljava/lang/String;)Lcom/xiaomi/mirror/synergy/PinAppInfo;
    ...
    :cond_5
    invoke-interface {p2, p1}, Lcom/xiaomi/mirror/synergy/GetAllPinAppListCallBack;->onSuccess(Ljava/util/List;)V
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_0
    ...
    invoke-interface {p2, v0, p1}, Lcom/xiaomi/mirror/synergy/GetAllPinAppListCallBack;->onFail(ILjava/lang/String;)V
...
# virtual methods
.method public addPinApp(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    .locals 7

    iget-object p0, p0, Lcom/xiaomi/mirror/synergy/MiuiSynergySdk;->mExecutor:Ljava/util/concurrent/Executor;

    new-instance v6, Lcom/xiaomi/mirror/synergy/MiuiSynergySdk$$ExternalSyntheticLambda1;
    ...
    invoke-direct/range {v0 .. v5}, Lcom/xiaomi/mirror/synergy/MiuiSynergySdk$$ExternalSyntheticLambda1;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/content/Context;)V
...
.method public addRemoteDeviceListener(Landroid/content/Context;Lcom/xiaomi/mirror/synergy/MiuiSynergySdk$IRemoteDeviceListener;)V
    ...
    invoke-static {p1}, Lcom/xiaomi/mirror/util/AppUtil;->getMirrorInstallStatus(Landroid/content/Context;)I
    ...
    const-string p1, "addRemoteDeviceListener: failed, mirror isn\'t installed"
    ...
    invoke-direct {v0, p0, v2}, Lcom/xiaomi/mirror/synergy/MiuiSynergySdk$DeviceReceiver;-><init>(Lcom/xiaomi/mirror/synergy/MiuiSynergySdk;Lcom/xiaomi/mirror/synergy/MiuiSynergySdk$1;)V
    ...
    const-string v2, "miui.intent.action.MIRROR_DEVICE_CHANGED"
    ...
    iget-object v2, p0, Lcom/xiaomi/mirror/synergy/MiuiSynergySdk;->mReceiver:Landroid/content/BroadcastReceiver;
...
.method public getAllPinApp(Landroid/content/Context;Lcom/xiaomi/mirror/synergy/GetAllPinAppListCallBack;)V
    .locals 1

    iget-object p0, p0, Lcom/xiaomi/mirror/synergy/MiuiSynergySdk;->mExecutor:Ljava/util/concurrent/Executor;

    new-instance v0, Lcom/xiaomi/mirror/synergy/MiuiSynergySdk$$ExternalSyntheticLambda0;

    invoke-direct {v0, p1, p2}, Lcom/xiaomi/mirror/synergy/MiuiSynergySdk$$ExternalSyntheticLambda0;-><init>(Landroid/content/Context;Lcom/xiaomi/mirror/synergy/GetAllPinAppListCallBack;)V
...
.method public getRemoteDeviceStatus(Landroid/content/Context;Ljava/lang/String;I)Z
    .locals 2
    ...
    const-string p2, "getRemoteDeviceStatus"
...
.method public getShareStatus(Landroid/content/Context;)Ljava/lang/String;
    ...
    const-string p1, "getShareStatus"
...
.method public getSubScreenPackageList(Landroid/content/Context;)Ljava/util/List;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    const-string v0, "getSubScreenPackageList"
    ...
    invoke-static {p1, v0, v2, v1}, Lcom/xiaomi/mirror/synergy/CallMethod;->doCall(Landroid/content/ContentResolver;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;

    move-result-object p1

    if-nez p1, :cond_0

    const-string p1, "getSubScreenPackageList result is null "
    ...
    const-string v1, "getSubScreenPackageList stringArrayList: "
...
.method public pinAppOptionExposed(Landroid/content/Context;Ljava/lang/String;)V
    .locals 1
    ...
    const-string p2, "pinAppOptionExposed"
    ...
    const-string p1, "pinAppOptionExposed result = null"
...
.method public removePinApp(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    .locals 7

    iget-object p0, p0, Lcom/xiaomi/mirror/synergy/MiuiSynergySdk;->mExecutor:Ljava/util/concurrent/Executor;

    new-instance v6, Lcom/xiaomi/mirror/synergy/MiuiSynergySdk$$ExternalSyntheticLambda2;
    ...
    invoke-direct/range {v0 .. v5}, Lcom/xiaomi/mirror/synergy/MiuiSynergySdk$$ExternalSyntheticLambda2;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/content/Context;)V
...
.method public removePinAppChangeCallBack(Lcom/xiaomi/mirror/synergy/PinAppChangeCallBack;Landroid/content/Context;)V
    .locals 1

    const/4 p1, 0x0

    iput-object p1, p0, Lcom/xiaomi/mirror/synergy/MiuiSynergySdk;->mPinAppChangeCallBack:Lcom/xiaomi/mirror/synergy/PinAppChangeCallBack;

    iget-object v0, p0, Lcom/xiaomi/mirror/synergy/MiuiSynergySdk;->mPinAppReceiver:Landroid/content/BroadcastReceiver;

    if-eqz v0, :cond_0

    invoke-virtual {p2, v0}, Landroid/content/Context;->unregisterReceiver(Landroid/content/BroadcastReceiver;)V

    iput-object p1, p0, Lcom/xiaomi/mirror/synergy/MiuiSynergySdk;->mPinAppReceiver:Landroid/content/BroadcastReceiver;
...
.method public removeRemoteDeviceListener(Landroid/content/Context;Lcom/xiaomi/mirror/synergy/MiuiSynergySdk$IRemoteDeviceListener;)V
    ...
    const-string p1, "removeRemoteDeviceListener: failed, mirror isn\'t installed"
...
.method public setMirrorDeviceStatusCallback(Landroid/content/Context;Ljava/lang/String;Lcom/xiaomi/mirror/synergy/MirrorDeviceStatusCallback;)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/xiaomi/mirror/synergy/MiuiSynergySdk$MiuiSynergyException;
    ...
    new-instance v0, Lcom/xiaomi/mirror/synergy/MiuiSynergySdk$12;

    invoke-direct {v0, p0, p3}, Lcom/xiaomi/mirror/synergy/MiuiSynergySdk$12;-><init>(Lcom/xiaomi/mirror/synergy/MiuiSynergySdk;Lcom/xiaomi/mirror/synergy/MirrorDeviceStatusCallback;)V
    ...
    invoke-virtual {v0}, Lcom/xiaomi/mirror/IMirrorDeviceStatusCallback$Stub;->asBinder()Landroid/os/IBinder;
    ...
    :goto_0
    const-string v0, "deviceStatusCallback"
    ...
    const-string p2, "setMirrorDeviceStatus"

    invoke-static {p1, p2, v1, p0}, Lcom/xiaomi/mirror/synergy/CallMethod;->doCall(Landroid/content/ContentResolver;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    const-string p1, "onRemoteDeviceStatus deviceId == null!"
...
.method public setPinAppChangeCallBack(Lcom/xiaomi/mirror/synergy/PinAppChangeCallBack;Landroid/content/Context;)V
    .locals 2

    const-string v0, "MiuiSynergy"

    const-string v1, "setPinAppChangeCallBack"

    invoke-static {v0, v1}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    iput-object p1, p0, Lcom/xiaomi/mirror/synergy/MiuiSynergySdk;->mPinAppChangeCallBack:Lcom/xiaomi/mirror/synergy/PinAppChangeCallBack;

    new-instance p1, Lcom/xiaomi/mirror/synergy/MiuiSynergySdk$PinAppChangeReceiver;

    const/4 v0, 0x0

    invoke-direct {p1, p0, v0}, Lcom/xiaomi/mirror/synergy/MiuiSynergySdk$PinAppChangeReceiver;-><init>(Lcom/xiaomi/mirror/synergy/MiuiSynergySdk;Lcom/xiaomi/mirror/synergy/MiuiSynergySdk$1;)V
    ...
    iget-object p0, p0, Lcom/xiaomi/mirror/synergy/MiuiSynergySdk;->mPinAppReceiver:Landroid/content/BroadcastReceiver;
...
.method public syncPinApp(Ljava/util/ArrayList;Landroid/content/Context;Lcom/xiaomi/mirror/synergy/GetAllPinAppListCallBack;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Ljava/util/ArrayList<",
            "Lcom/xiaomi/mirror/synergy/PinAppInfo;",
            ">;",
            "Landroid/content/Context;",
            "Lcom/xiaomi/mirror/synergy/GetAllPinAppListCallBack;",
            ")V"
        }
    .end annotation
    ...
    new-instance v0, Lcom/xiaomi/mirror/synergy/MiuiSynergySdk$$ExternalSyntheticLambda3;

    invoke-direct {v0, p1, p2, p3}, Lcom/xiaomi/mirror/synergy/MiuiSynergySdk$$ExternalSyntheticLambda3;-><init>(Ljava/util/ArrayList;Landroid/content/Context;Lcom/xiaomi/mirror/synergy/GetAllPinAppListCallBack;)V
