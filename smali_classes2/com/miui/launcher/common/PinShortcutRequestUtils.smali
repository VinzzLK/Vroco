...
.method private static query(Landroid/content/pm/LauncherApps;ILjava/lang/String;Landroid/content/ComponentName;Ljava/util/List;Landroid/os/UserHandle;)Ljava/util/List;
    ...
    const-string p4, "PinShortcutRequestUtils"
...
.method public static unpinAllShortcuts(Landroid/content/pm/LauncherApps;Ljava/lang/String;Landroid/os/UserHandle;)V
    .locals 5

    const-string v0, " all shortcuts"

    const-string v1, " and user "

    const-string v2, "PinShortcutRequestUtils"

    if-nez p0, :cond_0

    const-string p0, "LauncherApps is null"
    ...
    .line 96
    invoke-virtual {p0, p1, v3, p2}, Landroid/content/pm/LauncherApps;->pinShortcuts(Ljava/lang/String;Ljava/util/List;Landroid/os/UserHandle;)V
    ...
    const-string v3, "unpin package name "
    ...
    const-string v4, "Failed to unpin package name "
