...
.method public constructor <init>(Landroid/app/Activity;Lcom/miui/launcher/overlay/client/LauncherClient$ClientOptions;Lcom/miui/launcher/overlay/client/LauncherClientCallback;)V
    ...
    const-string v1, "mLauncherOverlayConnection.bindClient:"
    ...
    .line 68
    iget-object v3, p0, Lcom/miui/launcher/overlay/client/LauncherClient;->mOptions:Lcom/miui/launcher/overlay/client/LauncherClient$ClientOptions;

    invoke-static {v3}, Lcom/miui/launcher/overlay/client/LauncherClient$ClientOptions;->access$000(Lcom/miui/launcher/overlay/client/LauncherClient$ClientOptions;)Ljava/lang/String;
    ...
    .line 69
    invoke-virtual {p1, p3, v2}, Landroid/app/Activity;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;
    ...
    iput p2, p0, Lcom/miui/launcher/overlay/client/LauncherClient;->mServerVersion:I
...
.method private updateLayoutParams(Landroid/view/WindowManager$LayoutParams;)V
    ...
    const-string v0, "mLauncherOverlay = null:"
...
.method private updateOverlay()V
    ...
    invoke-static {v1}, Lcom/miui/launcher/overlay/client/LauncherClient$ClientOptions;->access$300(Lcom/miui/launcher/overlay/client/LauncherClient$ClientOptions;)F

    move-result v1

    const-string v2, "client_options_touch_slop"
...
.method public disconnectOnly()V
    .locals 2
    ...
    const-string v1, "disconnectOnly:"
    ...
    invoke-virtual {p0}, Lcom/miui/launcher/overlay/client/LauncherOverlayConnectionCompat;->disconnect()V
...
.method public onBindingDied()V
    ...
    invoke-interface {p0}, Lcom/miui/launcher/overlay/client/LauncherClientCallback;->onBindingDied()V
...
.method public onDestroy()V
    ...
    invoke-virtual {p0}, Lcom/miui/launcher/overlay/client/LauncherClient;->isDisconnectConnection()Z
...
.method onOverlayUpdate(Landroid/content/Context;)V
    ...
    .line 445
    invoke-virtual {p0}, Lcom/miui/launcher/overlay/client/LauncherClient;->isNeedReconnectWhenApkChanged()Z
...
.method public onServiceConnected()V
    ...
    invoke-interface {p0}, Lcom/miui/launcher/overlay/client/LauncherClientCallback;->onServiceConnected()V
