...
.method private getTForXValue(D)D
    ...
    .line 102
    iget-object v4, v0, Lmiuix/animation/function/Bezier;->originX:[D

    invoke-direct {v0, v4, v9, v10}, Lmiuix/animation/function/Bezier;->solveAxis([DD)D
    ...
    add-double v1, v9, v12

    invoke-direct {v0, v14, v1, v2}, Lmiuix/animation/function/Bezier;->solveAxis([DD)D
