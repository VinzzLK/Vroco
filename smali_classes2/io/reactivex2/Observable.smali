...
.method public static empty()Lio/reactivex2/Observable;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 1690
    sget-object v0, Lio/reactivex2/internal/operators/observable/ObservableEmpty;->INSTANCE:Lio/reactivex2/Observable;
...
.method public final doOnNext(Lio/reactivex2/functions/Consumer;)Lio/reactivex2/Observable;
    ...
    invoke-direct {p0, p1, v0, v1, v1}, Lio/reactivex2/Observable;->doOnEach(Lio/reactivex2/functions/Consumer;Lio/reactivex2/functions/Consumer;Lio/reactivex2/functions/Action;Lio/reactivex2/functions/Action;)Lio/reactivex2/Observable;
...
.method public final flatMap(Lio/reactivex2/functions/Function;)Lio/reactivex2/Observable;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<R:",
    ...
    .line 8507
    invoke-virtual {p0, p1, v0}, Lio/reactivex2/Observable;->flatMap(Lio/reactivex2/functions/Function;Z)Lio/reactivex2/Observable;
...
.method public final flatMap(Lio/reactivex2/functions/Function;Z)Lio/reactivex2/Observable;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<R:",
    ...
    .line 8536
    invoke-virtual {p0, p1, p2, v0}, Lio/reactivex2/Observable;->flatMap(Lio/reactivex2/functions/Function;ZI)Lio/reactivex2/Observable;
...
.method public final flatMap(Lio/reactivex2/functions/Function;ZI)Lio/reactivex2/Observable;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<R:",
    ...
    invoke-virtual {p0, p1, p2, p3, v0}, Lio/reactivex2/Observable;->flatMap(Lio/reactivex2/functions/Function;ZII)Lio/reactivex2/Observable;
...
.method public final flatMap(Lio/reactivex2/functions/Function;ZII)Lio/reactivex2/Observable;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<R:",
    ...
    .line 8607
    invoke-static {p4, v0}, Lio/reactivex2/internal/functions/ObjectHelper;->verifyPositive(ILjava/lang/String;)I

    .line 8608
    instance-of v0, p0, Lio/reactivex2/internal/fuseable/ScalarCallable;

    if-eqz v0, :cond_1

    .line 8610
    check-cast p0, Lio/reactivex2/internal/fuseable/ScalarCallable;

    invoke-interface {p0}, Lio/reactivex2/internal/fuseable/ScalarCallable;->call()Ljava/lang/Object;
    ...
    .line 8612
    invoke-static {}, Lio/reactivex2/Observable;->empty()Lio/reactivex2/Observable;
    ...
    .line 8614
    :cond_0
    invoke-static {p0, p1}, Lio/reactivex2/internal/operators/observable/ObservableScalarXMap;->scalarXMap(Ljava/lang/Object;Lio/reactivex2/functions/Function;)Lio/reactivex2/Observable;
    ...
    .line 8616
    :cond_1
    new-instance v6, Lio/reactivex2/internal/operators/observable/ObservableFlatMap;
    ...
    invoke-direct/range {v0 .. v5}, Lio/reactivex2/internal/operators/observable/ObservableFlatMap;-><init>(Lio/reactivex2/ObservableSource;Lio/reactivex2/functions/Function;ZII)V

    invoke-static {v6}, Lio/reactivex2/plugins/RxJavaPlugins;->onAssembly(Lio/reactivex2/Observable;)Lio/reactivex2/Observable;
