...
.method public static fromProviderInfo(Landroid/content/Context;Landroid/appwidget/AppWidgetProviderInfo;)Lcom/miui/home/launcher/LauncherAppWidgetProviderInfo;
    ...
    invoke-virtual {v0, v1}, Lcom/miui/home/launcher/widget/MIUIAppWidgetInfo;->initMiuiAttribute(Landroid/content/ComponentName;)V
    ...
    invoke-direct {v0, p0, v1, p1}, Lcom/miui/home/launcher/LauncherAppWidgetProviderInfo;->initSpans(Landroid/content/Context;ZLjava/lang/String;)V

    return-object v0
.end method

.method private initSpans(Landroid/content/Context;ZLjava/lang/String;)V
    .locals 2
    ...
    .line 63
    invoke-static {p3, p2}, Lcom/miui/home/launcher/MIUIWidgetUtil;->fullScreenWidth(Ljava/lang/String;Ljava/lang/String;)Z

    move-result p2

    .line 64
    iget-object p3, p0, Lcom/miui/home/launcher/LauncherAppWidgetProviderInfo;->providerInfo:Landroid/appwidget/AppWidgetProviderInfo;

    iget p3, p3, Landroid/appwidget/AppWidgetProviderInfo;->minResizeWidth:I

    invoke-static {p3, p2}, Lcom/miui/home/launcher/DeviceConfig;->getWidgetSpanX(IZ)I

    move-result p3

    iput p3, p0, Lcom/miui/home/launcher/ItemInfo;->minSpanX:I
    ...
    iput p3, p0, Lcom/miui/home/launcher/ItemInfo;->minSpanY:I

    .line 69
    sget-boolean p3, Lcom/miui/home/launcher/common/Utilities;->ATLEAST_S:Z
    ...
    iget v0, v0, Landroid/appwidget/AppWidgetProviderInfo;->maxResizeWidth:I
    ...
    .line 70
    invoke-static {v0, v1}, Lcom/miui/home/launcher/DeviceConfig;->getWidgetSpanX(IZ)I
    ...
    :goto_1
    iput v0, p0, Lcom/miui/home/launcher/LauncherAppWidgetProviderInfo;->maxSpanX:I
    ...
    iget v0, v0, Landroid/appwidget/AppWidgetProviderInfo;->maxResizeHeight:I
    ...
    iget v0, p3, Landroid/appwidget/AppWidgetProviderInfo;->targetCellWidth:I

    iget v1, p0, Lcom/miui/home/launcher/ItemInfo;->minSpanX:I

    if-lt v0, v1, :cond_3

    iget v1, p0, Lcom/miui/home/launcher/LauncherAppWidgetProviderInfo;->maxSpanX:I

    if-gt v0, v1, :cond_3

    iget p3, p3, Landroid/appwidget/AppWidgetProviderInfo;->targetCellHeight:I

    iget v1, p0, Lcom/miui/home/launcher/ItemInfo;->minSpanY:I
    ...
    .line 85
    iput p3, p0, Lcom/miui/home/launcher/ItemInfo;->spanY:I
    ...
    invoke-static {p1, p2}, Lcom/miui/home/launcher/DeviceConfig;->getWidgetSpanX(IZ)I
    ...
    const-string p2, "initSpans minW = "
    ...
    iget p2, p2, Landroid/appwidget/AppWidgetProviderInfo;->minWidth:I

    invoke-virtual {p1, p2}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string p2, " minSpanX = "

    invoke-virtual {p1, p2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget p2, p0, Lcom/miui/home/launcher/ItemInfo;->minSpanX:I
    ...
    const-string p2, "LauncherAppWidgetProviderInfo"
    ...
    const-string p3, "initSpans minH = "
    ...
    const-string p3, " minSpanY = "

    invoke-virtual {p1, p3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget p3, p0, Lcom/miui/home/launcher/ItemInfo;->minSpanY:I
...
.method public clone()Lcom/miui/home/launcher/LauncherAppWidgetProviderInfo;
    ...
    check-cast p0, Lcom/miui/home/launcher/LauncherAppWidgetProviderInfo;
...
.method public getAppWidgetId()I
    ...
    .line 136
    iget p0, p0, Lcom/miui/home/launcher/LauncherAppWidgetProviderInfo;->mAppWidgetId:I
...
.method public getWidgetCategoryId()I
    ...
    .line 162
    iget p0, p0, Lcom/miui/home/launcher/LauncherAppWidgetProviderInfo;->mWidgetCategory:I
