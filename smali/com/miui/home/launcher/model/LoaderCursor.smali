...
.method private insertApp(Landroid/content/pm/LauncherActivityInfo;)V
    ...
    .line 133
    iput-wide v0, v2, Lcom/miui/home/launcher/ItemInfo;->id:J
    ...
    iput-wide v3, v2, Lcom/miui/home/launcher/ItemInfo;->container:J
    ...
    iput v3, v2, Lcom/miui/home/launcher/ItemInfo;->cellY:I
    ...
    invoke-virtual {v2, v4, v3}, Lcom/miui/home/launcher/ShortcutInfo;->onAddToDatabase(Landroid/content/Context;Landroid/content/ContentValues;)V
...
.method public checkPackageNameChange(Lcom/miui/home/launcher/util/ComponentKey;)V
    ...
    iget-object v1, p1, Lcom/miui/home/launcher/util/ComponentKey;->user:Landroid/os/UserHandle;

    if-eqz v1, :cond_3

    iget-object v1, p0, Lcom/miui/home/launcher/model/LoaderCursor;->mAllAppsMap:Ljava/util/Map;
