...
.field private static final LAUNCHER_WIDGET_CORE_EXECUTOR:Ljava/util/concurrent/ExecutorService;
...
.field private static final sFolderPreviewSerialExecutor:Lcom/miui/home/library/utils/AsyncTaskExecutorHelper$SerialExecutor;
...
# direct methods
.method public static synthetic $r8$lambda$-Q0pa7Pct1pK0yTS9MnHK01xsoU(Ljava/lang/Runnable;Ljava/lang/Boolean;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/miui/home/library/utils/AsyncTaskExecutorHelper;->lambda$waitForUnlockAndRun$5(Ljava/lang/Runnable;Ljava/lang/Boolean;)V

    return-void
.end method

.method public static synthetic $r8$lambda$MX8DsaEzYE9Jb9rZt68Njlk8ikM(Ljava/lang/Runnable;)Ljava/lang/Thread;
    .locals 0

    invoke-static {p0}, Lcom/miui/home/library/utils/AsyncTaskExecutorHelper;->lambda$static$0(Ljava/lang/Runnable;)Ljava/lang/Thread;
...
.method public static synthetic $r8$lambda$S8s1kvCnDkQo8reIiNU4iS5IQF8(Ljava/util/function/Supplier;Ljava/lang/Void;)Ljava/lang/Object;
    .locals 0

    invoke-static {p0, p1}, Lcom/miui/home/library/utils/AsyncTaskExecutorHelper;->lambda$execParallel$1(Ljava/util/function/Supplier;Ljava/lang/Void;)Ljava/lang/Object;
...
.method public static synthetic $r8$lambda$bb9N4U7lk281VM6otl3QQaXXuX4(Ljava/lang/Runnable;Ljava/lang/Void;)Ljava/lang/Void;
    .locals 0

    invoke-static {p0, p1}, Lcom/miui/home/library/utils/AsyncTaskExecutorHelper;->lambda$execParallel$2(Ljava/lang/Runnable;Ljava/lang/Void;)Ljava/lang/Void;
...
.method public static synthetic $r8$lambda$gHDNNGWOt7QeUu-0R9btLdnRsv4(Ljava/lang/Runnable;)Ljava/lang/Thread;
    .locals 0

    invoke-static {p0}, Lcom/miui/home/library/utils/AsyncTaskExecutorHelper;->lambda$static$3(Ljava/lang/Runnable;)Ljava/lang/Thread;
...
.method public static synthetic $r8$lambda$tuYAV_ccmf1Ieb5N0k5hN_1KkMI(Landroid/os/UserHandle;Landroid/content/Context;Ljava/util/function/Consumer;Ljava/lang/Runnable;Ljava/lang/Void;)Ljava/lang/Boolean;
    .locals 0

    invoke-static {p0, p1, p2, p3, p4}, Lcom/miui/home/library/utils/AsyncTaskExecutorHelper;->lambda$waitForUnlockAndRun$4(Landroid/os/UserHandle;Landroid/content/Context;Ljava/util/function/Consumer;Ljava/lang/Runnable;Ljava/lang/Void;)Ljava/lang/Boolean;
...
.method static constructor <clinit>()V
    ...
    sput-object v7, Lcom/miui/home/library/utils/AsyncTaskExecutorHelper;->sPoolWorkQueue:Ljava/util/concurrent/BlockingQueue;
    ...
    sput v3, Lcom/miui/home/library/utils/AsyncTaskExecutorHelper;->CORE_POOL_SIZE:I

    .line 44
    new-instance v8, Lcom/miui/home/library/utils/AsyncTaskExecutorHelper$1;

    invoke-direct {v8}, Lcom/miui/home/library/utils/AsyncTaskExecutorHelper$1;-><init>()V

    sput-object v8, Lcom/miui/home/library/utils/AsyncTaskExecutorHelper;->sThreadFactory:Ljava/util/concurrent/ThreadFactory;
    ...
    .line 60
    sget-object v1, Lcom/miui/home/library/utils/AsyncTaskExecutorHelper$$ExternalSyntheticLambda0;->INSTANCE:Lcom/miui/home/library/utils/AsyncTaskExecutorHelper$$ExternalSyntheticLambda0;

    invoke-static {v1}, Ljava/util/concurrent/Executors;->newSingleThreadExecutor(Ljava/util/concurrent/ThreadFactory;)Ljava/util/concurrent/ExecutorService;

    move-result-object v1

    sput-object v1, Lcom/miui/home/library/utils/AsyncTaskExecutorHelper;->LAUNCHER_WIDGET_CORE_EXECUTOR:Ljava/util/concurrent/ExecutorService;
    ...
    invoke-virtual {v1, v0}, Lorg/greenrobot/eventbus/EventBusBuilder;->executorService(Ljava/util/concurrent/ExecutorService;)Lorg/greenrobot/eventbus/EventBusBuilder;
    ...
    .line 195
    sget-object v0, Lcom/miui/home/library/utils/AsyncTaskExecutorHelper$$ExternalSyntheticLambda1;->INSTANCE:Lcom/miui/home/library/utils/AsyncTaskExecutorHelper$$ExternalSyntheticLambda1;
    ...
    const-string v1, "Folder Task"

    const-wide/16 v2, 0x3c

    invoke-direct {v0, v1, v2, v3}, Lcom/miui/home/library/utils/AsyncTaskExecutorHelper$SerialExecutor;-><init>(Ljava/lang/String;J)V

    sput-object v0, Lcom/miui/home/library/utils/AsyncTaskExecutorHelper;->sFolderPreviewSerialExecutor:Lcom/miui/home/library/utils/AsyncTaskExecutorHelper$SerialExecutor;
...
.method private static exec(Ljava/util/function/Function;Ljava/util/function/Consumer;Ljava/lang/Object;Ljava/util/concurrent/Executor;Ljava/util/function/Consumer;)Landroid/os/AsyncTask;
    ...
    .line 153
    invoke-virtual {v0, p3, p0}, Landroid/os/AsyncTask;->executeOnExecutor(Ljava/util/concurrent/Executor;[Ljava/lang/Object;)Landroid/os/AsyncTask;
...
.method public static execParallel(Ljava/lang/Runnable;)V
    ...
    .line 173
    new-instance v0, Lcom/miui/home/library/utils/AsyncTaskExecutorHelper$$ExternalSyntheticLambda4;

    invoke-direct {v0, p0}, Lcom/miui/home/library/utils/AsyncTaskExecutorHelper$$ExternalSyntheticLambda4;-><init>(Ljava/lang/Runnable;)V
...
.method public static execParallel(Ljava/util/function/Supplier;Ljava/util/function/Consumer;)V
    ...
    .line 169
    new-instance v0, Lcom/miui/home/library/utils/AsyncTaskExecutorHelper$$ExternalSyntheticLambda5;

    invoke-direct {v0, p0}, Lcom/miui/home/library/utils/AsyncTaskExecutorHelper$$ExternalSyntheticLambda5;-><init>(Ljava/util/function/Supplier;)V
...
.method public static getFolderPreviewSerialExecutor()Lcom/miui/home/library/utils/AsyncTaskExecutorHelper$SerialExecutor;
    .locals 1

    .line 215
    sget-object v0, Lcom/miui/home/library/utils/AsyncTaskExecutorHelper;->sFolderPreviewSerialExecutor:Lcom/miui/home/library/utils/AsyncTaskExecutorHelper$SerialExecutor;
...
.method public static getWidgetCoreExecutor()Ljava/util/concurrent/Executor;
    .locals 1

    .line 188
    sget-object v0, Lcom/miui/home/library/utils/AsyncTaskExecutorHelper;->LAUNCHER_WIDGET_CORE_EXECUTOR:Ljava/util/concurrent/ExecutorService;
...
.method private static synthetic lambda$execParallel$1(Ljava/util/function/Supplier;Ljava/lang/Void;)Ljava/lang/Object;
    .locals 0
...
.method private static synthetic lambda$execParallel$2(Ljava/lang/Runnable;Ljava/lang/Void;)Ljava/lang/Void;
    .locals 0
...
.method private static synthetic lambda$static$0(Ljava/lang/Runnable;)Ljava/lang/Thread;
    ...
    const-string v1, "LauncherAppWidgetCoreThread"
...
.method private static synthetic lambda$waitForUnlockAndRun$4(Landroid/os/UserHandle;Landroid/content/Context;Ljava/util/function/Consumer;Ljava/lang/Runnable;Ljava/lang/Void;)Ljava/lang/Boolean;
    .locals 0
...
.method private static synthetic lambda$waitForUnlockAndRun$5(Ljava/lang/Runnable;Ljava/lang/Boolean;)V
    .locals 0
...
.method protected static waitForUnlockAndRun(Ljava/lang/Runnable;Ljava/lang/Runnable;Ljava/util/function/Consumer;Landroid/os/UserHandle;Landroid/content/Context;)V
    ...
    .line 272
    new-instance v0, Lcom/miui/home/library/utils/AsyncTaskExecutorHelper$$ExternalSyntheticLambda3;

    invoke-direct {v0, p3, p4, p2, p0}, Lcom/miui/home/library/utils/AsyncTaskExecutorHelper$$ExternalSyntheticLambda3;-><init>(Landroid/os/UserHandle;Landroid/content/Context;Ljava/util/function/Consumer;Ljava/lang/Runnable;)V

    new-instance p0, Lcom/miui/home/library/utils/AsyncTaskExecutorHelper$$ExternalSyntheticLambda2;

    invoke-direct {p0, p1}, Lcom/miui/home/library/utils/AsyncTaskExecutorHelper$$ExternalSyntheticLambda2;-><init>(Ljava/lang/Runnable;)V
