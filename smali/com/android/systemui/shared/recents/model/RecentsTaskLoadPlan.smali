...
.field private mReentrantLock:Ljava/util/concurrent/locks/ReentrantLock;
...
.method constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/android/systemui/shared/recents/model/RecentsTaskLoadPlan;->mReentrantLock:Ljava/util/concurrent/locks/ReentrantLock;
...
# virtual methods
.method public executePlan(Lcom/android/systemui/shared/recents/model/RecentsTaskLoadPlan$Options;Lcom/android/systemui/shared/recents/model/RecentsTaskLoader;Lcom/android/systemui/shared/recents/model/TaskResourceLoadQueue;)V
    .locals 16
    ...
    .line 333
    iget-object v3, v0, Lcom/android/systemui/shared/recents/model/RecentsTaskLoadPlan;->mReentrantLock:Ljava/util/concurrent/locks/ReentrantLock;
    ...
    .line 338
    iget-object v5, v0, Lcom/android/systemui/shared/recents/model/RecentsTaskLoadPlan;->mStack:Lcom/android/systemui/shared/recents/model/TaskStack;
    ...
    iget v13, v1, Lcom/android/systemui/shared/recents/model/RecentsTaskLoadPlan$Options;->runningTaskId:I
    ...
    .line 349
    :goto_1
    iget v13, v1, Lcom/android/systemui/shared/recents/model/RecentsTaskLoadPlan$Options;->numVisibleTasks:I
    ...
    .line 350
    :goto_2
    iget v15, v1, Lcom/android/systemui/shared/recents/model/RecentsTaskLoadPlan$Options;->numVisibleTaskThumbnails:I
    ...
    .line 353
    :goto_3
    iget-boolean v6, v1, Lcom/android/systemui/shared/recents/model/RecentsTaskLoadPlan$Options;->onlyLoadPausedActivities:Z
    ...
    .line 357
    :cond_4
    iget-boolean v6, v1, Lcom/android/systemui/shared/recents/model/RecentsTaskLoadPlan$Options;->loadIcons:Z
    ...
    :cond_8
    :goto_4
    iget-boolean v6, v1, Lcom/android/systemui/shared/recents/model/RecentsTaskLoadPlan$Options;->loadThumbnails:Z
    ...
    iget-object v6, v8, Lcom/android/systemui/shared/recents/model/Task;->key:Lcom/android/systemui/shared/recents/model/Task$TaskKey;

    iget-boolean v6, v6, Lcom/android/systemui/shared/recents/model/Task$TaskKey;->isAccessLocked:Z
    ...
    .line 388
    iput-boolean v8, v1, Lcom/android/systemui/shared/recents/model/RecentsTaskLoadPlan$Options;->onlyLoadForCache:Z
    ...
    .line 394
    iget-object v0, v0, Lcom/android/systemui/shared/recents/model/RecentsTaskLoadPlan;->mReentrantLock:Ljava/util/concurrent/locks/ReentrantLock;
...
.method public preloadPlan(Lcom/android/systemui/shared/recents/model/RecentsTaskLoader;ILjava/util/Set;Ljava/lang/String;)V
    .locals 50
    ...
    .line 214
    iget-object v5, v0, Lcom/android/systemui/shared/recents/model/RecentsTaskLoadPlan;->mReentrantLock:Ljava/util/concurrent/locks/ReentrantLock;
    ...
    .line 218
    :cond_0
    invoke-virtual {v0, v2, v8}, Lcom/android/systemui/shared/recents/model/RecentsTaskLoadPlan;->preloadRawTasks(IZ)V
    ...
    .line 225
    iget-object v12, v0, Lcom/android/systemui/shared/recents/model/RecentsTaskLoadPlan;->mRawTasks:Ljava/util/List;
    ...
    .line 250
    :goto_2
    iget-object v8, v0, Lcom/android/systemui/shared/recents/model/RecentsTaskLoadPlan;->mContext:Landroid/content/Context;
    ...
    .line 269
    invoke-direct {v0, v3, v11}, Lcom/android/systemui/shared/recents/model/RecentsTaskLoadPlan;->setTaskKeyThumbnailBlur(Ljava/util/Set;Lcom/android/systemui/shared/recents/model/Task$TaskKey;)Z
    ...
    .line 270
    invoke-direct {v0, v3, v12}, Lcom/android/systemui/shared/recents/model/RecentsTaskLoadPlan;->setTaskKeyThumbnailBlur(Ljava/util/Set;Lcom/android/systemui/shared/recents/model/Task$TaskKey;)Z
    ...
    .line 272
    invoke-direct {v0, v4, v11}, Lcom/android/systemui/shared/recents/model/RecentsTaskLoadPlan;->setTaskKeyScreening(Ljava/lang/String;Lcom/android/systemui/shared/recents/model/Task$TaskKey;)Z
    ...
    .line 273
    invoke-direct {v0, v4, v12}, Lcom/android/systemui/shared/recents/model/RecentsTaskLoadPlan;->setTaskKeyScreening(Ljava/lang/String;Lcom/android/systemui/shared/recents/model/Task$TaskKey;)Z

    move-result v7

    iput-boolean v7, v12, Lcom/android/systemui/shared/recents/model/Task$TaskKey;->isScreening:Z
    ...
    .line 275
    iget-object v7, v14, Landroid/app/ActivityManager$RecentTaskInfo;->taskDescription:Landroid/app/ActivityManager$TaskDescription;

    const/4 v8, 0x1

    invoke-virtual {v1, v11, v7, v5, v8}, Lcom/android/systemui/shared/recents/model/RecentsTaskLoader;->getAndUpdateActivityIcon(Lcom/android/systemui/shared/recents/model/Task$TaskKey;Landroid/app/ActivityManager$TaskDescription;Landroid/content/res/Resources;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 276
    iget-object v7, v15, Landroid/app/ActivityManager$RecentTaskInfo;->taskDescription:Landroid/app/ActivityManager$TaskDescription;

    invoke-virtual {v1, v12, v7, v5, v8}, Lcom/android/systemui/shared/recents/model/RecentsTaskLoader;->getAndUpdateActivityIcon(Lcom/android/systemui/shared/recents/model/Task$TaskKey;Landroid/app/ActivityManager$TaskDescription;Landroid/content/res/Resources;Z)Landroid/graphics/drawable/Drawable;

    move-result-object v7

    .line 277
    invoke-virtual {v1, v11, v5}, Lcom/android/systemui/shared/recents/model/RecentsTaskLoader;->getAndUpdateContentDescription(Lcom/android/systemui/shared/recents/model/Task$TaskKey;Landroid/content/res/Resources;)Ljava/lang/String;

    move-result-object v8

    .line 278
    invoke-virtual {v1, v12, v5}, Lcom/android/systemui/shared/recents/model/RecentsTaskLoader;->getAndUpdateContentDescription(Lcom/android/systemui/shared/recents/model/Task$TaskKey;Landroid/content/res/Resources;)Ljava/lang/String;
    ...
    .line 283
    invoke-direct {v0, v3, v10}, Lcom/android/systemui/shared/recents/model/RecentsTaskLoadPlan;->setTaskKeyThumbnailBlur(Ljava/util/Set;Lcom/android/systemui/shared/recents/model/Task$TaskKey;)Z
    ...
    .line 284
    invoke-direct {v0, v4, v10}, Lcom/android/systemui/shared/recents/model/RecentsTaskLoadPlan;->setTaskKeyScreening(Ljava/lang/String;Lcom/android/systemui/shared/recents/model/Task$TaskKey;)Z
    ...
    invoke-virtual {v7, v10}, Lcom/android/systemui/shared/recents/system/SecurityManagerWrapper;->isAccessLocked(Lcom/android/systemui/shared/recents/model/Task$TaskKey;)Z

    move-result v7

    iput-boolean v7, v10, Lcom/android/systemui/shared/recents/model/Task$TaskKey;->isAccessLocked:Z
    ...
    .line 294
    :goto_8
    invoke-virtual {v1, v10}, Lcom/android/systemui/shared/recents/model/RecentsTaskLoader;->getAndUpdateActivityInfo(Lcom/android/systemui/shared/recents/model/Task$TaskKey;)Landroid/content/pm/ActivityInfo;
    ...
    invoke-virtual {v1, v10, v8}, Lcom/android/systemui/shared/recents/model/RecentsTaskLoader;->getAndUpdateActivityTitle(Lcom/android/systemui/shared/recents/model/Task$TaskKey;Landroid/app/ActivityManager$TaskDescription;)Ljava/lang/String;

    move-result-object v22

    .line 296
    invoke-virtual {v1, v10, v5}, Lcom/android/systemui/shared/recents/model/RecentsTaskLoader;->getAndUpdateContentDescription(Lcom/android/systemui/shared/recents/model/Task$TaskKey;Landroid/content/res/Resources;)Ljava/lang/String;
    ...
    invoke-virtual {v1, v10, v8, v5, v11}, Lcom/android/systemui/shared/recents/model/RecentsTaskLoader;->getAndUpdateActivityIcon(Lcom/android/systemui/shared/recents/model/Task$TaskKey;Landroid/app/ActivityManager$TaskDescription;Landroid/content/res/Resources;Z)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v1, v8}, Lcom/android/systemui/shared/recents/model/RecentsTaskLoader;->getActivityPrimaryColor(Landroid/app/ActivityManager$TaskDescription;)I
    ...
    invoke-virtual {v1, v8}, Lcom/android/systemui/shared/recents/model/RecentsTaskLoader;->getActivityBackgroundColor(Landroid/app/ActivityManager$TaskDescription;)I
    ...
    iget v8, v13, Landroid/app/ActivityManager$RecentTaskInfo;->resizeMode:I

    move/from16 v32, v8

    iget-object v8, v13, Landroid/app/ActivityManager$RecentTaskInfo;->topActivity:Landroid/content/ComponentName;

    move-object/from16 v33, v8

    iget-object v8, v13, Landroid/app/ActivityManager$RecentTaskInfo;->baseActivity:Landroid/content/ComponentName;
    ...
    invoke-virtual {v9, v7, v8}, Landroid/util/SparseIntArray;->get(II)I
    ...
    invoke-virtual {v9, v7, v11}, Landroid/util/SparseIntArray;->put(II)V
    ...
    .line 320
    invoke-virtual {v0, v6}, Lcom/android/systemui/shared/recents/model/RecentsTaskLoadPlan;->lockApplication(Ljava/util/ArrayList;)V
    ...
    .line 324
    iget-object v2, v0, Lcom/android/systemui/shared/recents/model/RecentsTaskLoadPlan;->mContext:Landroid/content/Context;

    const/4 v3, 0x0

    invoke-virtual {v1, v2, v6, v3}, Lcom/android/systemui/shared/recents/model/TaskStack;->setTasks(Landroid/content/Context;Ljava/util/List;Z)V
...
.method public preloadRawTasks(IZ)V
    .locals 7

    .line 121
    iget-object v0, p0, Lcom/android/systemui/shared/recents/model/RecentsTaskLoadPlan;->mReentrantLock:Ljava/util/concurrent/locks/ReentrantLock;
    ...
    .line 129
    :cond_0
    iget-object p0, p0, Lcom/android/systemui/shared/recents/model/RecentsTaskLoadPlan;->mReentrantLock:Ljava/util/concurrent/locks/ReentrantLock;
...
.method public updatePlan(Ljava/util/Set;Ljava/lang/String;)Z
    .locals 10
    ...
    const-string/jumbo v2, "updatePlan, isAcquireLockSuccess="
    ...
    const-string v2, "RecentsTaskLoadPlan"
    ...
    .line 179
    invoke-virtual {v5}, Lcom/android/systemui/shared/recents/model/Task;->hasMultipleTasks()Z
    ...
    .line 180
    iget-object v7, v5, Lcom/android/systemui/shared/recents/model/Task;->cti1Key:Lcom/android/systemui/shared/recents/model/Task$TaskKey;

    .line 181
    iget-object v5, v5, Lcom/android/systemui/shared/recents/model/Task;->cti2Key:Lcom/android/systemui/shared/recents/model/Task$TaskKey;
    ...
    .line 184
    iget-boolean v9, v7, Lcom/android/systemui/shared/recents/model/Task$TaskKey;->isThumbnailBlur:Z
    ...
    iput-boolean v8, v5, Lcom/android/systemui/shared/recents/model/Task$TaskKey;->isScreening:Z

    .line 187
    iget-boolean v5, v7, Lcom/android/systemui/shared/recents/model/Task$TaskKey;->isScreening:Z
    ...
    :goto_4
    iput-boolean v5, v6, Lcom/android/systemui/shared/recents/model/Task$TaskKey;->isScreening:Z
    ...
    iput-boolean v5, v6, Lcom/android/systemui/shared/recents/model/Task$TaskKey;->isThumbnailBlur:Z
    ...
    invoke-virtual {v5, v6}, Lcom/android/systemui/shared/recents/system/SecurityManagerWrapper;->isAccessLocked(Lcom/android/systemui/shared/recents/model/Task$TaskKey;)Z

    move-result v5

    iput-boolean v5, v6, Lcom/android/systemui/shared/recents/model/Task$TaskKey;->isAccessLocked:Z
...
.method public updateTaskAccessLockedState()V
    ...
    invoke-virtual {v3, v2}, Lcom/android/systemui/shared/recents/system/SecurityManagerWrapper;->isAccessLocked(Lcom/android/systemui/shared/recents/model/Task$TaskKey;)Z

    move-result v3

    iput-boolean v3, v2, Lcom/android/systemui/shared/recents/model/Task$TaskKey;->isAccessLocked:Z
